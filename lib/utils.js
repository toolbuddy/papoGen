...
utils.render = function(out_path,result,theme){
    mkdirp(out_path, function(err) {
        if (err) {
            ...
            // copy theme
            if(theme=='paper'){
                fsx.copyFileSync(path.join(__dirname, 'theme',theme,'monokai.css'),path.join(out_path,'asset','monokai.css'))
                fsx.copyFileSync(path.join(__dirname, 'theme',theme,'paper.min.css'),path.join(out_path,'asset','paper.min.css'))
            }
            else if(theme=='papogen'){
                fsx.copyFileSync(path.join(__dirname, 'theme',theme,'papogen.css'),path.join(out_path,'asset','papogen.css'))
            }
            else{
